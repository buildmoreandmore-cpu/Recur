...
const SAMPLE_CLIENTS: Client[] = [
  {
    ...
    appointments: [
      { date: '2026-02-15', service: 'Color + Cut', price: 220, status: 'completed' },
      { date: '2026-04-12', service: 'Color + Gloss', price: 185, status: 'upcoming' },
      { date: '2026-06-07', service: 'Pre-vacation color', price: 220, status: 'scheduled' },
      { date: '2026-08-23', service: 'Post-vacation refresh', price: 185, status: 'scheduled' },
      { date: '2026-09-20', service: 'Wedding prep', price: 280, status: 'event' },
      { date: '2026-11-15', service: 'Holiday refresh', price: 220, status: 'scheduled' },
    ],
    notes: '',
    status: 'confirmed',
  },
  {
    ...
    appointments: [
      { date: '2026-02-08', service: 'Cut + Style', price: 85, status: 'completed' },
      { date: '2026-04-18', service: 'Cut + Style', price: 85, status: 'upcoming' },
    ],
    notes: '',
    status: 'at-risk',
  },
  {
    ...
    appointments: [
      { date: '2026-02-22', service: 'Color + Cut + Gloss', price: 270, status: 'completed' },
      { date: '2026-05-03', service: 'Color + Cut + Gloss', price: 270, status: 'upcoming' },
    ],
    notes: '',
    status: 'confirmed',
  },
  {
    ...
    growOutComfort: '8+ weeks',
    appointments: [
      { date: '2026-02-15', service: 'Shampoo + Style', price: 55, status: 'completed' },
      { date: '2026-05-15', service: 'Shampoo + Style', price: 55, status: 'upcoming' },
    ],
    notes: '',
    status: 'pending',
  },
  {
    ...
    growOutComfort: '4 weeks',
    appointments: [
      { date: '2026-02-11', service: 'Full Highlights + Cut', price: 330, status: 'completed' },
      { date: '2026-04-08', service: 'Full Highlights + Cut', price: 330, status: 'upcoming' },
    ],
    notes: '',
    status: 'confirmed',
  },
